    ...
    <div class="container">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="{{ route('users.show',Auth::id()) }}"><i class="far fa-user me-2"></i>个人中心</a>
                <a class="dropdown-item" href="{{ route('users.edit',Auth::id()) }}"><i class="far fa-edit me-2"></i>编辑资料</a>
